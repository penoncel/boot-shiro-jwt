...
public class JwtRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken auth) throws AuthenticationException {
        ...
        try{
            ...
            if(verify){
                ...
                if (StringUtils.isEmpty(phone)) {
                    ...
                    o.put("code", ErrorState.TOKEN_PHONE_IS_NULL.getCode());
                    o.put("msg",  ErrorState.TOKEN_PHONE_IS_NULL.getMsg());
                    throw new AuthenticationException(o.toString());
                }
            }
        } catch (JWTDecodeException e){
            JSONObject o = new JSONObject();
            o.put("code", ErrorState.TOKEN_ERROR.getCode());
            o.put("msg",  ErrorState.TOKEN_ERROR.getMsg());
            throw new AuthenticationException(o.toString());
        }catch (TokenExpiredException e){
            JSONObject o = new JSONObject();
            o.put("code", ErrorState.TOKEN_INVALID.getCode());
            o.put("msg",  ErrorState.TOKEN_INVALID.getMsg());
            throw new AuthenticationException(o.toString());
        ...
        if(redisService.exists(LogingUserKey.loginUserIinfo,phone)){
            loginUser = redisService.get(LogingUserKey.loginUserIinfo,phone, LoginUser.class);
        }else{
        ...
        if (loginUser.getUser() == null) {
            JSONObject o = new JSONObject();
            o.put("code", ErrorState.TOKEN_PHONE_POJO_IS_NULL.getCode());
            o.put("msg",  ErrorState.TOKEN_PHONE_POJO_IS_NULL.getMsg());
            throw new AuthenticationException(o.toString());
        }
